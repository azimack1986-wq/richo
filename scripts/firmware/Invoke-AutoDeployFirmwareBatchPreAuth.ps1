...
.NOTES
    ...
    - Version 20.7.0-preauth. Tracks Invoke-AutoDeployFirmwareBatchControl.ps1 20.7.0. Set in $ScriptVersion below and stamped onto every row of the run summary
