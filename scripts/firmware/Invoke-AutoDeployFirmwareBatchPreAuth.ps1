...
.NOTES
    ...
    - Version 19.3.1-preauth. Tracks Invoke-AutoDeployFirmwareBatchControl.ps1 19.3.1. Set in $ScriptVersion below and stamped onto every row of the run summary
