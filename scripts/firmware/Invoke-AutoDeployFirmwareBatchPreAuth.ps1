...
.NOTES
    ...
    - Version 19.1.0-preauth. Tracks Invoke-AutoDeployFirmwareBatchControl.ps1 19.1.0. Set in $ScriptVersion below and stamped onto every row of the run summary
