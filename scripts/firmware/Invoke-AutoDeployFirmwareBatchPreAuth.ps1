...
.NOTES
    ...
    - Version 19.2.0-preauth. Tracks Invoke-AutoDeployFirmwareBatchControl.ps1 19.2.0. Set in $ScriptVersion below and stamped onto every row of the run summary
